...
SELECT 
    ...
    CASE
        ...
        WHEN departure_delay_minutes > 0 AND departure_delay_minutes <= 15 THEN 'Slight Delay'
        WHEN departure_delay_minutes > 15 AND departure_delay_minutes <= 60 THEN 'Moderate Delay'
        ELSE 'Severe Delay'
